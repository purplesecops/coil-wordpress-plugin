...
function load_full_assets() : void {
	...
	$strings = apply_filters(
		...
		[
			...
			'button_margin_top'           => Admin\get_coil_button_setting( 'coil_button_top_margin' ),
			'button_margin_right'         => Admin\get_coil_button_setting( 'coil_button_right_margin' ),
			'button_margin_bottom'        => Admin\get_coil_button_setting( 'coil_button_bottom_margin' ),
			'button_margin_left'          => Admin\get_coil_button_setting( 'coil_button_left_margin' ),
