 ...
 */
 Cypress.Commands.add('resetSite', () => {
	...
	cy.exec('wp db query \'DELETE FROM wp_options WHERE option_name IN ("coil_global_settings_group", "coil_content_settings_posts_group", "coil_content_settings_excerpt_group", "coil_messaging_settings_group", "coil_appearance_settings_group");\'');
	// Adds a payment pointer in
	cy.exec('wp db query \'INSERT INTO wp_options (option_name, option_value) VALUES ("coil_global_settings_group", "a:2:{s:23:\"coil_payment_pointer_id\";s:35:\"https://example.com/.well-known/pay\";s:22:\"coil_content_container\";s:28:\".content-area .entry-content\";}");\'');
});